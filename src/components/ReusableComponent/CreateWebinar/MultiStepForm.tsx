...
const MultiStepForm = ({ steps, onComplete }: Props) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-white border border-border rounded-3xl overflow-hidden max-w-6xl mx-auto backdrop-blur-[106px]">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="relative">
                      ...
                      {index < steps.length - 1 && (
                        <div className="absolute top-8 left-4 w-0.5 h-24 bg-gray-700 overflow-hidden">
                          <motion.div
                            initial={{
