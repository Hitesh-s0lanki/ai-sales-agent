  ...
  return (
    <Tabs defaultValue="all" className="w-full flex flex-col gap-8">
      <PageHeader
        ...
        heading="Home to all your webinars"
      ...
      <TabsContent
        value="all"
        className="w-full grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-4  place-items-start place-content-start gap-x-6 gap-y-10 px-6  ">
        {webinars?.length > 0 ? (
